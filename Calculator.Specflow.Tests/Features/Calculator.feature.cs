...
namespace Calculator.Specflow.Tests.Features
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("Calculator", Description="\tCalculator for adding two numbers", SourceFile="Features\\Calculator.feature", SourceLine=0)]
